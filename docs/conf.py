...
try:
    ...
    version = fakepy_mcp.__version__
    project = fakepy_mcp.__title__
    copyright = fakepy_mcp.__copyright__
    author = fakepy_mcp.__author__
except ImportError:
    version = "0.1"
    project = "fake-py-mcp"
...
epub_identifier = "https://github.com/barseghyanartur/fake-py-mcp"  # URL or ISBN
epub_scheme = "URL"  # or "ISBN"
epub_uid = "https://github.com/barseghyanartur/fake-py-mcp"
